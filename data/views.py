...
### Basic Index Page for PaleoCore hosted projects
...
# ### Class based public View of the Turkana Data
# class TurkanaIndexView(FiberPageMixin, generic.ListView):
...
### Definition Based Public View of Turkana Data

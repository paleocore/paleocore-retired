...
from .ontologies import ITEM_TYPE_VOCABULARY, PSR_COLLECTOR_CHOICES, \
    PSR_COLLECTING_METHOD_VOCABULARY, PSR_BASIS_OF_RECORD_VOCABULARY, PSR_COLLECTION_CODES
import os
import utm
...
class Locality(models.Model):
    ...
    collection_code = models.CharField(null=True, blank=True, choices=PSR_COLLECTION_CODES, max_length=10)
...
class Occurrence(models.Model):
    ...
    collector = models.CharField(max_length=50, blank=True, null=True, choices=PSR_COLLECTOR_CHOICES)
    ...
    def save(self, *args, **kwargs):
        ...
        # call the normal psr_occurrence save method using alternate database
...
class Biology(Occurrence):
    ...
    identification_qualifier = models.ForeignKey(IdentificationQualifier, related_name='psr_id_qualifier_bio_occurrences',
                                                 null=True, blank=True)
    qualifier_taxon = models.ForeignKey(Taxon, null=True, blank=True, related_name='psr_qualifier_taxon_bio_occurrences')
...
class Hydrology(models.Model):
    ...
    class Meta:
        verbose_name = "PSR Hydrology"
        verbose_name_plural = "PSR Hydrology"

...
class Occurrence(models.Model):
    ...
    stratigraphic_marker_upper = models.CharField(max_length=255, blank=True, db_column="stratigraphicmarkerupper")
    distance_from_upper = models.DecimalField(max_digits=38, decimal_places=8, blank=True, null=True, db_column="distancefromupper")
    stratigraphic_marker_lower = models.CharField(max_length=255, blank=True, db_column="stratigraphicmarkerlower")
    distance_from_lower = models.DecimalField(max_digits=38, decimal_places=8, blank=True, null=True, db_column="distancefromlower")
    stratigraphic_marker_found = models.CharField(max_length=255, blank=True, db_column="stratigraphicmarkerfound")
    distance_from_found = models.DecimalField(max_digits=38, decimal_places=8, blank=True, null=True, db_column="distancefromfound")
    stratigraphic_marker_likely = models.CharField(max_length=255, blank=True, db_column="stratigraphicmarkerlikely")
    distance_from_likely = models.DecimalField(max_digits=38, decimal_places=8, blank=True, null=True, db_column="distancefromlikely")
    stratigraphic_member = models.CharField(max_length=255, blank=True, db_column="stratigraphicmember")
    ...
    geom = models.GeometryField(srid=32637, blank=True, null=True, db_column="shape")

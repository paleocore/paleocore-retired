    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(default=b'MLP', max_length=20, null=True, verbose_name=b'Collection Code', blank=True)),
                ...
                ('image', models.FileField(max_length=255, null=True, upload_to=b'uploads/images/mlp', blank=True)),
        ...
        migrations.CreateModel(
            name='Biology',
            fields=[
                ('occurrence_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='mlp.Occurrence')),
                ...
                ('identification_qualifier', models.ForeignKey(related_name='mlp_biology_occurrences', to='taxonomy.IdentificationQualifier')),
                ('taxon', models.ForeignKey(related_name='mlp_biology_occurrences', to='taxonomy.Taxon')),
            ],
            options={

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(default=b'SF', max_length=20, null=True, verbose_name=b'Collection Code', blank=True)),
                ...
                ('collecting_method', models.CharField(blank=True, max_length=50, verbose_name=b'Collecting Method', choices=[(b'Surface Standard', b'Surface Standard'), (b'Surface Intensive', b'Surface Intensive'), (b'Surface Complete', b'Surface Complete'), (b'Exploratory Survey', b'Exploratory Survey'), (b'Dry Screen 5mm', b'Dry Screen 5mm'), (b'Dry Screen 2mm', b'Dry Screen 2mm'), (b'Wet Screen 1mm', b'Wet Screen 1mm')])),
                ...
                ('analyticalunit2', models.CharField(max_length=255, null=True, blank=True)),
                ('analyticalunit3', models.CharField(max_length=255, null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='Biology',
            fields=[
                ('occurrence_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='san_francisco.Occurrence')),
                ('infraspecificepithet', models.CharField(max_length=50, null=True, blank=True)),
                ('infraspecificrank', models.CharField(max_length=50, null=True, blank=True)),
                ('authoryearofscientificname', models.CharField(max_length=50, null=True, blank=True)),
                ('nomenclaturalcode', models.CharField(max_length=50, null=True, blank=True)),
                ('identificationqualifier', models.CharField(max_length=50, null=True, blank=True)),
                ('identifiedby', models.CharField(max_length=100, null=True, blank=True)),
                ('dateidentified', models.DateTimeField(null=True, blank=True)),
                ('typestatus', models.CharField(max_length=50, null=True, blank=True)),
                ('sex', models.CharField(max_length=50, null=True, blank=True)),
                ('lifestage', models.CharField(max_length=50, null=True, blank=True)),
                ...
                ('faunanotes', models.TextField(max_length=64000, null=True, blank=True)),
                ('toothupperorlower', models.CharField(max_length=50, null=True, blank=True)),
                ('toothnumber', models.CharField(max_length=50, null=True, blank=True)),
                ('toothtype', models.CharField(max_length=50, null=True, blank=True)),
                ...
                ('elementmodifier', models.CharField(max_length=50, null=True, blank=True)),
                ...
                ('identification_qualifier', models.ForeignKey(related_name='san_francisco_biology_occurrences', to='taxonomy.IdentificationQualifier')),
                ('taxon', models.ForeignKey(related_name='san_francisco_biology_occurrences', to='taxonomy.Taxon')),
            ],
            options={
                'verbose_name': 'San Francisco Biology',
                'verbose_name_plural': 'San Francisco Biology',
            },
            bases=('san_francisco.occurrence',),
        ),
    ]

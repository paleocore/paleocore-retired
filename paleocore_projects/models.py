...
class Project(models.Model):
    ...
    isPublic = models.BooleanField(default=False, help_text="Is the raw data to be made publicly viewable?")
    displaySummaryInfo = models.BooleanField(default=True, help_text="Should project summary data be published? Only uncheck this in extreme circumstances")

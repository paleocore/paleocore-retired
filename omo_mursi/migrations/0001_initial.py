    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(default=b'MUR', max_length=20, null=True, verbose_name=b'Collection Code', blank=True)),
                ...
                ('collector', models.CharField(blank=True, max_length=50, null=True, choices=[(b'Michelle Drapeau', b'Michelle Drapeau'), (b'Jonathan Wynn', b'Jonathan Wynn'), (b'Al Deino', b'Al Deino')])),
                ...
                ('image', models.FileField(max_length=255, null=True, upload_to=b'uploads/images/omo_mursi', blank=True)),
        ...
        migrations.CreateModel(
            name='Biology',
            fields=[
                ('occurrence_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='omo_mursi.Occurrence')),
                ...
                ('identification_qualifier', models.ForeignKey(related_name='omo_mursi_biology_occurrences', to='taxonomy.IdentificationQualifier')),
                ('taxon', models.ForeignKey(related_name='omo_mursi_biology_occurrences', to='taxonomy.Taxon')),
            ],
            options={

...
import shapefile
from west_turkana.forms import UploadForm, UploadKMLForm, DownloadKMLForm, ChangeXYForm
...
class UploadKMLView(generic.FormView):
    ...
    # e.g. success_url = reverse("paleocore_projects:west_turkana:west_turkana_upload_confirmation")

...
class drp_occurrence(models.Model):
    ...
    collectioncode = models.CharField("Collection Code",null=True, blank=True,max_length=20,choices=(("DIK","DIK"),("ASB","ASB")))
    paleolocalitynumber = models.IntegerField("Locality Number",null=True, blank=True)
    paleosublocality = models.CharField("Sublocality",null=True, blank=True,max_length=50)
    itemnumber = models.CharField("Item Number",null=True, blank=True,max_length=50)
    ...
    yearcollected = models.IntegerField(null=True, blank=True)
    ...
    stratigraphicmember = models.CharField("Geological Member",null=True, blank=True,max_length=255)
...
class drp_biology(models.Model):
    ...
    uli4 = models.IntegerField()
    uli5 = models.IntegerField()
    uri1 = models.IntegerField()
    uri2 = models.IntegerField()
    uri3 = models.IntegerField()
    uri4 = models.IntegerField()
    uri5 = models.IntegerField()
    ulc = models.IntegerField()
    urc = models.IntegerField()
    ulp1 = models.IntegerField()
    ulp2 = models.IntegerField()
    ulp3 = models.IntegerField()
    ulp4 = models.IntegerField()
    urp1 = models.IntegerField()
    urp2 = models.IntegerField()
    urp3 = models.IntegerField()
    urp4 = models.IntegerField()
    ulm1 = models.IntegerField()
    ulm2 = models.IntegerField()
    ulm3 = models.IntegerField()
    urm1 = models.IntegerField()
    urm2 = models.IntegerField()
    urm3 = models.IntegerField()
    lli1 = models.IntegerField()
    lli2 = models.IntegerField()
    lli3 = models.IntegerField()
    lli4 = models.IntegerField()
    lli5 = models.IntegerField()
    lri1 = models.IntegerField()
    lri2 = models.IntegerField()
    lri3 = models.IntegerField()
    lri4 = models.IntegerField()
    lri5 = models.IntegerField()
    llc = models.IntegerField()
    lrc = models.IntegerField()
    llp1 = models.IntegerField()
    llp2 = models.IntegerField()
    llp3 = models.IntegerField()
    llp4 = models.IntegerField()
    lrp1 = models.IntegerField()
    lrp2 = models.IntegerField()
    lrp3 = models.IntegerField()
    lrp4 = models.IntegerField()
    llm1 = models.IntegerField()
    llm2 = models.IntegerField()
    llm3 = models.IntegerField()
    lrm1 = models.IntegerField()
    lrm2 = models.IntegerField()
    lrm3 = models.IntegerField()

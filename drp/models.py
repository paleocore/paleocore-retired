...
class Locality(models.Model):
    ...
    lower_limit_in_section = models.FloatField(null=True, blank=True)
...
class Occurrence(models.Model):
    ...
    stratigraphic_section = models.CharField(null=True, blank=True,max_length=50)
    stratigraphic_height_in_meters = models.FloatField(null=True, blank=True)
...
class Biology(Occurrence):
    ...
    um_tooth_row_length_mm = models.FloatField(null=True, blank=True)
    #umtoothrowlengthmm = models.FloatField(null=True,blank=True)
    um_1_length_mm = models.FloatField(null=True, blank=True)
    #um1lengthmm = models.FloatField(null=True,blank=True)
    um_1_width_mm = models.FloatField(null=True, blank=True)
    #um1widthmm = models.FloatField(null=True,blank=True)
    um_2_length_mm = models.FloatField(null=True,blank=True)
    um_2_width_mm = models.FloatField(null=True,blank=True)
    um_3_length_mm = models.FloatField(null=True,blank=True)
    um_3_width_mm = models.FloatField(null=True,blank=True)
    lm_tooth_row_length_mm = models.FloatField(null=True, blank=True)
    lm_1_length = models.FloatField(null=True, blank=True)
    lm_1_width = models.FloatField(null=True, blank=True)
    lm_2_length = models.FloatField(null=True, blank=True)
    lm_2_width = models.FloatField(null=True, blank=True)
    lm_3_length = models.FloatField(null=True, blank=True)
    lm_3_width = models.FloatField(null=True, blank=True)

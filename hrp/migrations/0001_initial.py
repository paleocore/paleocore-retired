    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(blank=True, max_length=10, null=True, choices=[(b'AL', b'AL')])),
                ('paleo_sublocality', models.CharField(max_length=50, null=True, blank=True)),
                ('sublocality', models.CharField(max_length=50, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_code', models.CharField(blank=True, max_length=20, null=True, verbose_name=b'Collection Code', choices=[(b'AL', b'AL')])),
                ...
                ('collector', models.CharField(blank=True, max_length=50, null=True, choices=[(b'Christopher Campisano', b'Christopher Campisano'), (b'Donald Johanson', b'Donald Johanson'), (b'Thomas Gray', b'Thomas Gray'), (b'William Kimbel', b'William Kimbel'), (b'Kaye Reed', b'Kaye Reed')])),
                ...
                ('field_number', models.DateTimeField(null=True, blank=True)),
                ...
                ('analytical_unit_1', models.CharField(max_length=255, null=True, blank=True)),
                ...
                ('image', models.FileField(max_length=255, null=True, upload_to=b'uploads/images/hrp', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_qualifier', models.ForeignKey(related_name='hrp_biology_occurrences', to='taxonomy.IdentificationQualifier')),
                ('taxon', models.ForeignKey(related_name='hrp_biology_occurrences', to='taxonomy.Taxon')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='locality',
            field=models.ForeignKey(blank=True, to='hrp.Locality', null=True),
        ),
        migrations.AddField(
            model_name='image',
            name='occurrence',
            field=models.ForeignKey(related_name='hrp_occurrences', to='hrp.Occurrence'),
        ),
        migrations.AddField(
            model_name='file',
            name='occurrence',
            field=models.ForeignKey(to='hrp.Occurrence'),
        ),
    ]

...
class OccurrenceCreationMethodTests(TestCase):
    ...
    def test_occurrence_admin_view(self):
        ...
        response = self.client.get('/admin/hrp/', follow=True)
...
#        response = self.client.get('/admin/hrp/biology/')
#        self.assertEqual(response.status_code, 200)
#        response = self.client.get('/admin/hrp/biology/'+str(new_occurrence.pk)+'/')
#        self.assertEqual(response.status_code, 200)
#
#
